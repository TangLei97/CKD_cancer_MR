...
##renal carcinoma
rcc_m <- fread('~/Desktop/ckd cancer/summary data/Laskar_31231134_Males.gz') 
setnames(rcc_m, c(1, 2, 4:7, 10, 11, 14, 15), c('rsid', 'chr', 'a1', 'a2', 'ea', 'or', 'se', 'p', 'eaf_con', 'eaf_cas'))
rcc_m[, `:=` (beta = log(or),
              nea = ifelse(a1 == ea, a2, a1),
              eaf = (eaf_con + eaf_cas)/2)]
rcc_f <- fread('~/Desktop/ckd cancer/summary data/Laskar_31231134_Females.gz') 
setnames(rcc_f, c(1, 2, 4:7, 10, 11, 14, 15), c('rsid', 'chr', 'a1', 'a2', 'ea', 'or', 'se', 'p', 'eaf_con', 'eaf_cas'))
rcc_f[, `:=` (beta = log(or),
              nea = ifelse(a1 == ea, a2, a1),
              eaf = (eaf_con + eaf_cas)/2)]
